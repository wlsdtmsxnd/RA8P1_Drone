...
/** UART on SCI Instance. */
            extern const uart_instance_t      g_uart_flow_tof;

            /** Access the UART instance using these structures when calling API functions directly (::p_api is not used). */
            extern sci_b_uart_instance_ctrl_t     g_uart_flow_tof_ctrl;
            extern const uart_cfg_t g_uart_flow_tof_cfg;
            extern const sci_b_uart_extended_cfg_t g_uart_flow_tof_cfg_extend;

            #ifndef up_tof_uart_callback
